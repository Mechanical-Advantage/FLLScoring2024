...
schedule_judging_rooms = ["Room 1", "Room 2", "Room 3"]  # for judging overview

# General config for schedule
schedule_starttime = 1668951000  # unix time, when does the first match & judging session begin?
...
schedule_judging_outlength = 600  # secs, how long should the break between judging sessions take?
